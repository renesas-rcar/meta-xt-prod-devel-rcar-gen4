DESCRIPTION = "Linux kernel for Xen DomD on R-Car S4 based board"
...
SRC_URI:append:spider = "\
    file://r8a779f0-spider-domd.dts;subdir=git/arch/${ARCH}/boot/dts/renesas \
    file://r8a779f0-spider-xen.dts;subdir=git/arch/${ARCH}/boot/dts/renesas \
    file://xen-chosen.dtsi;subdir=git/arch/${ARCH}/boot/dts/renesas \
"

SRC_URI:append:s4sk = "\
    file://r8a779f0-s4sk-domd.dts;subdir=git/arch/${ARCH}/boot/dts/renesas \
    file://r8a779f0-s4sk-xen.dts;subdir=git/arch/${ARCH}/boot/dts/renesas \
    file://xen-chosen.dtsi;subdir=git/arch/${ARCH}/boot/dts/renesas \
"

SRC_URI:append:vc4 = "\
    file://r8a779f0-vc4-domd.dts;subdir=git/arch/${ARCH}/boot/dts/renesas \
    file://r8a779f0-vc4-xen-base.dts;subdir=git/arch/${ARCH}/boot/dts/renesas \
    file://r8a779f0-vc4-xen.dts;subdir=git/arch/${ARCH}/boot/dts/renesas \
    file://xen-chosen-vc4.dtsi;subdir=git/arch/${ARCH}/boot/dts/renesas \
"

KERNEL_DEVICETREE:spider = "\
    renesas/r8a779f0-spider-xen.dtb \
    renesas/r8a779f0-spider-domd.dtb \
"

KERNEL_DEVICETREE:s4sk = "\
    renesas/r8a779f0-s4sk-xen.dtb \
    renesas/r8a779f0-s4sk-domd.dtb \
"

KERNEL_DEVICETREE:vc4 = "\
    renesas/r8a779f0-vc4-xen.dtb \
    renesas/r8a779f0-vc4-domd.dtb \
"
